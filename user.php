            ...
            echo ' <option value="'.$resultcourse["id"].'">'.$resultcourse["stream"].'</option>';
                ...
                <div class="details">
                    <table border=0 width="100%">
                        <tr>
                        <td style="border-bottom:1px solid white;color:black;background:yellow;font-weight:700;" colspan="2">STUDENT DETAILS</td>
                        </tr>
    ...
    if(mysqli_num_rows($sqlcourse) > 0)
    {
        ...
        if(strlen($resultcourse['stream'])>26){
            echo "...";
                        ...
                        <tr>
                        <td style="border-bottom:1px solid white;color:white;background:green;font-weight:400;">Dates</td>
                        <td>';
                ...
                //now code for pass will be here only
                if($result['img'] == 0){
                    echo '<div class="uploadimg">

                            <p>Upload Your Image to get your Pass Issued.</p>
                         <div class="img">
                                <img id="outputprofile"  src="" alt="" />
                            </div>
                            <div class="upload">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <input type="file" accept="image/*" name="profileimg" onchange="loadFilep(event,0)" required />

                                <input type="submit" value="Upload" name="uploadprofile" class="btn">
                    ...
                    echo '
                    <div class="details passdetails">
                        <table border=0 stye width="100%">
                            <tr>
                            <td style="border-bottom:1px solid white;color:yellow;font-weight:400;
                            display:flex;
                            justify-content:space-between;
                            aling-items:center;
                            
                            " colspan="2">
                            <span>KOSHISH PASS STATUS</span>';
                        ...
                        if($result['pass_status'] == 0){
                            ...
                            echo '<a href="viewpass.php?id='.$user_id.'" target="_blank">
                            <button 
...
?>
      ...
      output.style.width = "150px";
        ...
        <center><br><button style='width:20%;
        margin:20px 0 0 0 ;
            ...
            font-size:16px;
            padding-top:4px;
            padding-bottom:4px;' onMouseOver="this.style.backgroundColor='#3DB166'" onMouseOut="this.style.backgroundColor='#192F59'" onclick="window.location.replace('php/logout.php')">Log Out</button></center><br>
    </section>
    </div>
