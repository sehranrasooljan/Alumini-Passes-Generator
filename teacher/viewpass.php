...
<div class="floatingprint">
    ...
    if( $result['pass_status'] ==0){
        echo '<a href="issue.php?user='.$user_id.'&teach='.$teach_id.'"><button>Issue Pass</button></a>';
    }
    ?>
...
if(strlen($resultcourse['stream'])>40){
    echo "...";
            ...
            <div class="teacher">
            <h3>REF. <?php echo $result_teach['user_type'];?> DETAILS</h3>
            <div class="teach-detils">
            <p class="std-text "><i class="fa-solid fa-user"></i> <span><?php echo $result_teach['user_name']; ?></span>
                    </p>
                    <p class="std-text"><i class="fa-solid fa-envelope"></i> 
                    <span><?php echo $result_teach['user_email']; ?></span>
                </p>
                    <p class="std-text"><i class="fa-solid fa-phone"></i><span><?php echo $result_teach['user_phone']; ?></span></p>
                    
                    <?php 
                    
                    if($result_teach['user_course'] != 0){

                        echo '<p class="std-text"><i class="fa-solid fa-book"></i> <span>'.substr($resultcourse['stream'],0,40).'  </span></p>';
                        ...
                        <!-------------------------- QR code-------------------- -->
            <div class="qr">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=http://<?php 
                
                
                echo $_SERVER['HTTP_HOST'];
                
                // echo "192.168.1.82";
                ?>/viewpass.php?id=<?php echo $user_id; ?>" alt="">
                <p>Scan to Verify</p>
